...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "workspace.welcomeHint":
      "All session tabs are closed. Open a session from the sidebar: pick a project group and press + for a new session, or click any session to open it in a tab.",
    "workspace.openRecent": "Open most recent session",
