...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.pushPermissionDescription":
      "將本站加入主畫面後（iPhone 需 iOS 16.4+），工作階段完成且頁面不在前景時，可在鎖定畫面收到系統通知。若通知不再送達，可回到這裡重新註冊。註冊必須由點擊觸發，因此不會自動彈出授權。",
    ...
    "workspace.welcomeHint":
      "所有工作階段分頁均已關閉。從側邊欄開啟工作階段：在專案群組上按「+」新增工作階段，或點擊任意工作階段在分頁中開啟。",
    "workspace.openRecent": "開啟最近的工作階段",
